...
namespace QuartzTests.Jobs
{
    ...
    public class WorkingForLongerTime : IJob
    {
        private readonly ILogger<WorkingForLongTime> _logger;
        private readonly IServiceProvider _provider;

        public WorkingForLongerTime(ILogger<WorkingForLongTime> logger, IServiceProvider provider)
        {
